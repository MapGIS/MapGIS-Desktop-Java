 ...
 * @date 2020-06-16.
 */
public class EditLineSample extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        buttonTest.setOnAction(event -> {
            SFeatureCls cls = (SFeatureCls)this.vectorLayer.getData();
            GeoVarLine line = (GeoVarLine)cls.getGeometry(42);
            line.append3D(new Dot3D(-150,300,0.0));

            SketchGeometry sketchGeometry = new SketchGeometry();
            sketchGeometry.setLayer(this.vectorLayer);
            sketchGeometry.setObjID(42);
            sketchGeometry.setGeometry(line);
