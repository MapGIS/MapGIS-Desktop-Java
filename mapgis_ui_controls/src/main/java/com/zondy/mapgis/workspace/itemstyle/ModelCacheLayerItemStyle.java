 ...
 * @date 2019/11/13
 */
public class ModelCacheLayerItemStyle implements IItemStyle {
    private ModelCacheLayerPopMenu modelCacheLayerPopMenu;
    private Image image;

    /**
     * 模型缓存图层节点样式
     */
    public ModelCacheLayerItemStyle() {
        modelCacheLayerPopMenu = new ModelCacheLayerPopMenu();
        image = new Image(getClass().getResourceAsStream("/Png_CacheLayer_16.png"));
    }
