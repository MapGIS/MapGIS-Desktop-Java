 ...
 * @date 2019/11/11
 */
public class MapItemStyle implements IItemStyle {
    private MapPopMenu mapPopMenu;
    private Image image;
     ...
     */
    public MapItemStyle() {
        mapPopMenu = new MapPopMenu();
        image = new Image(getClass().getResourceAsStream("/Png_MapView_16.png"));
    }
