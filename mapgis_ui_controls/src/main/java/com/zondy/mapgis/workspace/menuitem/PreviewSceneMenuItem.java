 ...
 * @date 2019/11/18
 */
public class PreviewSceneMenuItem implements ISingleMenuItem {
    ...
    public void onClick(DocumentItem item) {
        this.workspace.fireMenuItemClick(new MenuItemClickEvent(this, getClass(), item));
    }
    ...
    public Image getImage() {
        return new Image(getClass().getResourceAsStream("/Png_PreviewScene_16.png"));
    }
