 ...
 * @date 2019/11/18
 */
public class ExportLayerRasterMenuItem implements ISingleMenuItem {
    /**
     * 点击菜单项
     *
     * @param item 文档项
    ...
    public Image getImage() {
        return new Image(getClass().getResourceAsStream("/Png_ExportLayer_16.png"));
    }
