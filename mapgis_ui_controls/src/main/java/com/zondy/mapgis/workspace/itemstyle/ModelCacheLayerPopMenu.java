...
import com.zondy.mapgis.scene.ModelCacheLayer;
 ...
 * @date 2019/11/13
 */
public class ModelCacheLayerPopMenu implements ISinglePopMenu {
    ...
    public void opening(DocumentItem item) {
        if (item instanceof ModelCacheLayer) {
            LayerState layerState = ((ModelCacheLayer) item).getState();
