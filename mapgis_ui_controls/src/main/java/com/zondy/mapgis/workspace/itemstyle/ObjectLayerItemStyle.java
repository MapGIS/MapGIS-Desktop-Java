 ...
 * @date 2020/04/27
 */
public class ObjectLayerItemStyle implements IItemStyle {
    private ObjectLayerPopMenu objectLayerPopMenu;
    private Image image;

    public ObjectLayerItemStyle() {
        objectLayerPopMenu = new ObjectLayerPopMenu();
        image = new Image(getClass().getResourceAsStream("/Png_OCls_16.png"));
    }
