 ...
 * @date 2019/11/13
 */
public class MultiMapItemStyle implements IItemStyle {
    private MultiMapPopMenu multiMapPopMenu;

    /**
     * 多选地图节点样式
     */
    public MultiMapItemStyle() {
        multiMapPopMenu = new MultiMapPopMenu();
    }
