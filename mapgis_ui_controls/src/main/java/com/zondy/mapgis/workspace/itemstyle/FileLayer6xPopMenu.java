 ...
 * @date 2019/12/23
 */
public class FileLayer6xPopMenu implements ISinglePopMenu {
    private IWorkspace workspace;
    private IMenuItem[] menuItems;

    public FileLayer6xPopMenu(){
...
//        menuItems[4] = new Save6xLayerMenuItem();
//        menuItems[5] = new Giveup6xLayerMenuItem();
        menuItems[6] = new SetCurrentDisplayRangeMenuItem();
        menuItems[7] = new SetMinDisplayScaleMenuItem();
        menuItems[8] = new SetMaxDisplayScaleMenuItem();
        menuItems[9] = new ClearDisplayScaleMenuItem();
        menuItems[10] = new DeleteLayerMenuItem();
    ...
    public void opening(DocumentItem item) {
        if (item instanceof FileLayer6x)
        {
            ...
            LayerState layerState = fileLayer6x.getState();
