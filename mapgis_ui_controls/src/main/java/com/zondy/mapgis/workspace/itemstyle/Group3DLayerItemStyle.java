 ...
 * @date 2019/11/13
 */
public class Group3DLayerItemStyle implements IItemStyle {
    private Group3DLayerPopMenu group3DLayerPopMenu;
    private Image image;

    /**
     * 三维组图层节点风格
     */
    public Group3DLayerItemStyle() {
        group3DLayerPopMenu = new Group3DLayerPopMenu();
