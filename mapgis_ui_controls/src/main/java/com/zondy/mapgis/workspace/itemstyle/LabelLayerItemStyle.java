 ...
 * @date 2019/11/13
 */
public class LabelLayerItemStyle implements IItemStyle {
    private LabelLayerPopMenu labelLayerPopMenu;
    private Image image;

    /**
     * 三维注记图层节点风格
     */
    public LabelLayerItemStyle() {
        labelLayerPopMenu = new LabelLayerPopMenu();
        image = new Image(getClass().getResourceAsStream("/Png_LabelLayer_16.png"));
    }
