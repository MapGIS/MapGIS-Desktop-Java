 ...
 * @date 2019/11/18
 */
public class SortByDefaultRuleMenuItem implements ISingleMenuItem {
    ...
    public void onClick(DocumentItem item) {
        ...
        alert.setContentText("按约束类型排序，待支持");
        alert.showAndWait();
    }
    ...
    public Image getImage() {
        return new Image(getClass().getResourceAsStream("/Png_SortByDefaultRule_16.png"));
    }
