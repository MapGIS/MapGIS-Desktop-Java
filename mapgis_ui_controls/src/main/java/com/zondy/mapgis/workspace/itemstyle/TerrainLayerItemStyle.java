 ...
 * @date 2019/11/13
 */
public class TerrainLayerItemStyle implements IItemStyle {
    private TerrainLayerPopMenu terrainLayerPopMenu;
    private Image image;

    /**
     * 三维地形图层节点样式
     */
    public TerrainLayerItemStyle() {
        terrainLayerPopMenu = new TerrainLayerPopMenu();
        image = new Image(getClass().getResourceAsStream("/Png_TerrainLayer_16.png"));
    }
