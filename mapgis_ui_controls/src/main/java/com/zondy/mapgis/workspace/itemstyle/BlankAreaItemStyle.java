 ...
 * @date 2019/10/29
 */
public class BlankAreaItemStyle implements IItemStyle {
    private BlankAreaPopMenu blankAreaPopMenu;
    private Image image;

    /**
     * 空白处节点风格
     */
    public BlankAreaItemStyle() {
        this.blankAreaPopMenu = new BlankAreaPopMenu();
        this.image = null;
    }
