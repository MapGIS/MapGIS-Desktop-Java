 ...
 * @date 2019/11/18
 */
public class AddToLayerMenuItem implements ISingleMenuItem {
    ...
    public Image getImage() {
        return new Image(getClass().getResourceAsStream("/Png_AddToLayer_16.png"));
    }
