 ...
 * @date 2019/11/18
 */
public class EditLayerMenuItem implements ISingleMenuItem {
        ...
        if (item instanceof MapLayer) {
            ...
            if (layer instanceof FileLayer6x) {
                ...
                for (int i = 0; i < layer6X.getCount(); i++) {
                    ...
                    sLayer.setState(LayerState.Editable);
                }
            } else {
                layer.setState(LayerState.Editable);
            }
...
//                }
    ...
    public Image getImage() {
        return new Image(getClass().getResourceAsStream("/Png_NodeEditable_16.png"));
    }
