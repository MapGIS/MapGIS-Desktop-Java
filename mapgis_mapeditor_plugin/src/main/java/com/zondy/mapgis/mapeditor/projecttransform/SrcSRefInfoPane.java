 ...
 * 源参照系信息面板
 */
public class SrcSRefInfoPane extends GridPane {
    private String srcSRefInfoText = "";
    private TextArea srcSrefInfo = null;
    public SrcSRefInfoPane()
    {
        srcSrefInfo = new TextArea();
        srcSrefInfo.setEditable(false);
        getChildren().addAll(srcSrefInfo);
        this.setHgap(5);
        this.setVgap(5);
     ...
     * 获取参考系信息
     */
    public String getSrcSRefInfoText()
    {
        return this.srcSRefInfoText;
    }
    /**
     * 设置参考系信息
     */
    public void setSrcSRefInfoText(String text)
    {
        this.srcSRefInfoText = text;
        this.srcSrefInfo.setText(text);
    }
